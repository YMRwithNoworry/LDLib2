...
public final class ForgeClientBootstrap {
    ...
    public static void init() {
        ...
        eventBus.addListener(ForgeClientBootstrap::clientSetup);
        eventBus.addListener(ForgeClientBootstrap::registerRenderers);
        eventBus.addListener(ForgeClientBootstrap::registerShaders);
        eventBus.addListener(ForgeClientBootstrap::registerTooltipComponents);
        eventBus.addListener(ForgeClientBootstrap::registerClientReloadListeners);
        eventBus.addListener(ForgeClientBootstrap::registerGeometryLoaders);
        eventBus.addListener(ForgeClientBootstrap::registerAdditionalModels);
        MinecraftForge.EVENT_BUS.addListener(ForgeClientBootstrap::registerClientCommands);
    }
