...
public class DummyWorld extends Level {
    ...
    public void addEntity(Entity entity) {
        if (net.neoforged.neoforge.common.NeoForge.EVENT_BUS.post(new net.neoforged.neoforge.event.entity.EntityJoinLevelEvent(entity, this))) return;
    ...
    @Override
    public void gameEvent(GameEvent pGameEvent, Vec3 pPosition, GameEvent.Context pContext) {
    }
