            ...
            return switch (rlConfig.value()) {
                case FONT -> new SearchComponentConfigurator<>(name, supplier, consumer, defaultValue(field, String.class), forceUpdate,
                        (word, handler) -> {
                            ...
                            if (current.toString().toLowerCase().contains(search)) {
                ...
                case ITEM_TAG_KEY -> new TagKeySearchComponent.Item(name,
                        ...
                        TagKey.create(Registries.ITEM, defaultValue(field, ResourceLocation.class)),
                        forceUpdate
                );
                case BLOCK_TAG_KEY -> new TagKeySearchComponent.Block(name,
                        ...
                        TagKey.create(Registries.BLOCK, defaultValue(field, ResourceLocation.class)),
                        forceUpdate
                );
                case FLUID_TAG_KEY -> new TagKeySearchComponent.Fluid(name,
                        ...
                        TagKey.create(Registries.FLUID, defaultValue(field, ResourceLocation.class)),
                        forceUpdate
                );
