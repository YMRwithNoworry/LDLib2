...
public final class PrimitiveAccessor<TYPE> implements IDirectAccessor<TYPE> {
    ...
    private final StreamCodec<? super FriendlyByteBuf, TYPE> streamCodec;

    private PrimitiveAccessor(PrimitiveCodec<TYPE> codec, StreamCodec<? super FriendlyByteBuf, TYPE> streamCodec, Class<?> ...operandTypes) {
        this.operandTypes = operandTypes;
        this.codec = codec;
        this.streamCodec = streamCodec;
    }

    public static <T> PrimitiveAccessor<T> of(PrimitiveCodec<T> codec, StreamCodec<? super FriendlyByteBuf, T> streamCodec, Class<?> ...operandTypes) {
